...
def is_sub_list(node, neighbor):
    splits1=node.split(' ')
    splits2=neighbor.split(' ')
    if splits2[0] in splits1:
        i=splits1.index(splits2[0]) # splits2 in splits1
        if i>-1 and splits1[i:i+len(splits2)]==splits2:
            return True;
    if splits1[0] in splits2:
        i=splits2.index(splits1[0]) # splits1 in splits2
        if i>-1 and splits2[i:i+len(splits1)]==splits1:
            return True;
    return False;
